...
$stmt->execute();
		$i = 1; while ($row = $stmt->fetch()) { ?>
			<span class="a"><?php echo  "<h1 style='color:maroon ;text-shadow: 1px 1px 2px black, 0 0 10px pink, 0 0 5px darkred;font-family:Dancing Script;font-weight:bold;font-size:43;'>".$i;if($i==1){echo "&nbsp";} ?> </span>
				<span class="b"><a href="edit.php?id=<?php echo $row['id']; ?>&user=<?php echo $use ;?>"><img src="Edit-icon.png" height=30 width=30></a> 
				 <?php echo $row['Task']; ?> </center></span>
                                ...
                                <center><h1 style='color:maroon ;text-shadow: 1px 1px 2px black, 0 0 10px pink, 0 0 5px darkred;font-family:Dancing Script;font-weight:bold;font-size:43;'>Created on : <?php echo $row['Date'];?></h1></center>
				<?php if($row['Complete']!=0000-00-00)echo  "<center><h1 style='color:maroon ;text-shadow: 1px 1px 2px black, 0 0 10px pink, 0 0 5px darkred;font-family:Dancing Script;font-weight:bold;font-size:43;'>Completed on : ".$row['Complete']."</h1></center>";?>
